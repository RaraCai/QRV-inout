...
def render_suc_detail(data:pd.DataFrame):
    ...
    bar=Bar(init_opts=opts.InitOpts(theme=ThemeType.WONDERLAND,width=f'{WIDTH*0.35}px',height=f'{HEIGHT*0.4}px')).add_xaxis(data.index.tolist())
    ...
    components.html(bar.render_embed(),width=WIDTH*0.45,height=HEIGHT*0.4)
